...
Since the finite subgroups of $SL_2(\C)$ has a 2-to-1 correspondence with the finite subgroups of $SO(3)$, and $SO(3)$ is the group of 3D rotations, they can be associated with symmetry groups of solids. Specifically each finite subgroup of $SL_2(\C)$ has a surjective group homomorphism to a finite subgroup of $SO(3)$ with kernel either of order 2 or 1. Below, in figure~\ref{fig:3d_solids}, we show some illustration of solid figures labeled with the ADE diagrams coming from the subgroup of $SL_2(\C)$ which their symmetry group corresponds to.
